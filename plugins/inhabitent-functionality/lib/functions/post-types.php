...
function inhabitent_cpt_product() {
	...
	$args = array(
		...
		'description'           => __( 'Listing of items to sell', 'text_domain' ),
		'labels'                => $labels,
...
function inhabitent_adventures_post() {

	$labels = array(
		'name'                  => 'Adventures',
		'singular_name'         => 'Adventure',
		'menu_name'             => 'Adventures',
		'name_admin_bar'        => 'Adventure Post Type',
		...
		'items_list'            => 'Adventure Item list',
		'items_list_navigation' => 'Adventure Items navigation',
...
add_action( 'init', 'inhabitent_adventures_post', 0 );